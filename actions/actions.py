...
RESPONE_INTENT_ABOUT_PROJECT = {
 ...
 "viewzz": "- A project in the field of web \n- It uses technology PHP",
 ...
 "training php": "Training PHP (of project type NoBill, project status is In Progress)customer is NCC, PM by Thien Dang An, contact at thien.dang@ncc.asia.",
